<div class="column-header">
	<div class="header-title-wrapper">
		<div class="header-title">
			...
			<a href="javascript:void(0);" onclick="javascript:$.scrollTo('#locatie-roermond', 1000)" class="scroll-down">Locatie Roermond &darr;</a>

			<a href="javascript:void(0);" onclick="javascript:$.scrollTo('#locatie-echt', 1000)" class="scroll-down">Locatie Echt &darr;</a>
		</div>
	</div>
