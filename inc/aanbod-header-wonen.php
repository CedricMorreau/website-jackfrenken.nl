		...
		<div class="image-container">
			...
			<div id="royal-slider" class="royalSlider rsMinW visibleNearby">
				...
				foreach ($mediaList as $key => $media) {
					...
					echo '<a class="rsImg" href="' . $fullImage . '" data-rsTmb="' . $tnImage . '" data-rsBigImg="' . $fullImage . '">' . $val['objectDetails_Adres_NL_Woonplaats'] . ' - ' . obj_generateAddress($val['objectDetails_Adres_NL_Straatnaam'], $val['objectDetails_Adres_NL_Huisnummer'], $val['objectDetails_Adres_NL_HuisnummerToevoeging']) . '</a>' . PHP_EOL;
