<div class="column-header">
	...
	<div class="header-title-wrapper">
		<div class="header-title">
			...
			<?php echo utf8_encode_compat($val['project_ProjectDetails_Projectnaam']); ?></h1>
		...
		<div class="image-container">
			...
			<div id="royal-slider" class="royalSlider rsMinW visibleNearby">
				...
				foreach ($mediaList as $key => $media) {
					...
					$fullImage = $dynamicRoot . 'og_media/nieuwbouw_' . $val['project_NVMVestigingNR'] . '_' . $val['project_ObjectTiaraID']. '/' . $media['bestandsnaam'];
					$tnImage = $dynamicRoot . 'og_media/nieuwbouw_' . $val['project_NVMVestigingNR'] . '_' . $val['project_ObjectTiaraID']. '/' . $media['bestandsnaam_medium'];
