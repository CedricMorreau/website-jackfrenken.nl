...
define("E_VAL_REQUIRED_VALUE", "Vul de waarde van %s in");
define("E_VAL_MAXLEN_EXCEEDED", "De maximum lengte voor %s is overschreden.");
define("E_VAL_MINLEN_CHECK_FAILED", "De minimale lengte voor %s is %d karakters");
define("E_VAL_ALNUM_CHECK_FAILED", "De waarde van %s dient alfanummeriek te zijn (A-z0-9)");
define("E_VAL_ALNUM_S_CHECK_FAILED", "De waarde van %s dient alfanummeriek te zijn (A-z0-9)");
define("E_VAL_NUM_CHECK_FAILED", "De waarde van %s dient nummeriek te zijn");
define("E_VAL_ALPHA_CHECK_FAILED", "De waarde van %s dient alleen uit letters te bestaan");
define("E_VAL_ALPHA_S_CHECK_FAILED", "De waarde van %s dient alleen uit letters te bestaan");
define("E_VAL_EMAIL_CHECK_FAILED", "Dit dient een geldig e-mailadres te zijn");
define("E_VAL_LESSTHAN_CHECK_FAILED", "De waarde van %s dient kleiner te zijn dan %f");
define("E_VAL_GREATERTHAN_CHECK_FAILED", "De waarde van %s dient groter te zijn dan %f");
define("E_VAL_REGEXP_CHECK_FAILED", "De opgegeven waarde bevat een onjuist formaat %s");
define("E_VAL_DONTSEL_CHECK_FAILED", "Ongeldige keuze gemaakt voor %s");
define("E_VAL_SELMIN_CHECK_FAILED", "Er dienen minimaal %d opties gekozen te worden voor %s");
define("E_VAL_SELONE_CHECK_FAILED", "Kies een optie voor %s");
define("E_VAL_EQELMNT_CHECK_FAILED", "De waarde van %s moet gelijk zijn aan de waarde van %s");
define("E_VAL_NEELMNT_CHECK_FAILED", "De waarde van %s moet ongelijk zijn aan de waarde van %s");
